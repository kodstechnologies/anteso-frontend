...
export const handleExportToExcel = (details: any, tools: any[]) => {
  ...
  const templateData = [
    ...
    ["ConsistencyOfRadiationOutput", "Table2_Exp1", "0", "", "Output Meas 1 (mGy)"],
    ["ConsistencyOfRadiationOutput", "Table2_Exp2", "0", "", "Output Meas 2 (mGy)"],
    ["ConsistencyOfRadiationOutput", "Table2_Exp3", "0", "", "Output Meas 3 (mGy)"],
    ["ConsistencyOfRadiationOutput", "Table2_Exp4", "0", "", "Output Meas 4 (mGy)"],
    ["ConsistencyOfRadiationOutput", "Table2_Exp5", "0", "", "Output Meas 5 (mGy)"],
    ...
    ["MeasurementOfMaLinearity", "Table2_mAsApplied", "0", "", "mA Applied"],
    ["MeasurementOfMaLinearity", "Table2_Result_0", "0", "", "Meas 1 (mGy)"],
    ["MeasurementOfMaLinearity", "Table2_Result_1", "0", "", "Meas 2 (mGy)"],
    ["MeasurementOfMaLinearity", "Table2_Result_2", "0", "", "Meas 3 (mGy)"],
