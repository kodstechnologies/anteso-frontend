...
const Services = () => {
    ...
    const [initialRecords, setInitialRecords] = useState(sortBy(items, 'serviceType'));
                ...
                <div className="invoice-table">
                    <div className="mb-4.5 px-5 flex md:items-center md:flex-row flex-col gap-5">
                        <div className="flex items-center gap-2">
                            ...
                            <Link to="/admin/services/add" className="btn btn-primary gap-2">
                                <IconPlus />
                                Add New
                            </Link>
                        </div>
                                ...
                                },
                                {
                                    ...
                                    render: ({ id }) => (
                                        <div className="flex gap-4 items-center w-max mx-auto">
                                            <NavLink to="/admin/services/edit" className="flex hover:text-info">
