                ...
                <div className="max-w-[794px] mx-auto border-2 border-gray-800 p-6 shadow-lg">
                        ...
                        <table className="w-full border-collapse border border-gray-300 text-xs sm:text-sm">
                            ...
                            <tbody>
                                ...
                                <tr className="border-b border-gray-300">
                                    ...
                                    <td className="border border-gray-300 px-3 py-2 text-right text-red-600">-{format(salary.leaveDeduction || 0)}</td>
                                </tr>
                    ...
                    {/* <div className="mb-6">
                        <div className="flex justify-between items-center">
                            <span className="font-semibold text-gray-700">Payslip Status:</span>
                            <span
                                className={`px-3 py-1 rounded-full text-sm font-medium ${salary.status === "Paid"
