...
const AddOrder = () => {
    const SubmittedForm = Yup.object().shape({
        dealerName: Yup.string().required('Please fill the Field'),
                    ...
                    <Form className="space-y-5">
                        <div className="panel">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-4">
                                <div className={submitCount ? (errors.dealerName ? 'has-error' : 'has-success') : ''}>
                                    <label htmlFor="dealerName">Dealer/Manufacturer Name </label>
                                    <Field name="dealerName" type="text" id="dealerName" placeholder="Enter Hospital Name" className="form-input" />
                                    {submitCount ? errors.dealerName ? <div className="text-danger mt-1">{errors.dealerName}</div> : <div className="text-success mt-1">Looks Good!</div> : ''}
                                </div>
