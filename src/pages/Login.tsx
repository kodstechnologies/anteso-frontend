...
import { FaEye, FaEyeSlash } from 'react-icons/fa';
import logo from '../assets/logo/logo-sm.png';
import { adminLogin, staffLogin } from '../api';
import Cookies from 'js-cookie';
import { jwtDecode } from 'jwt-decode';
        ...
        onSubmit: async (values) => {
            try {
                ...
                if (activeTab === 'admin') {
                    ...
                    response = await staffLogin(values);
                }
                    ...
                    <div className="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[600px] py-20">
                        <div className="mx-auto w-full max-w-[440px]">
                            ...
                            <div className="mb-6 flex justify-center gap-4">
                                <button
                                    type="button"
                                    className={`px-4 py-2 rounded-md font-medium ${activeTab === 'admin' ? 'bg-primary text-white' : 'bg-white/30 text-white-dark'}`}
                                ...
                                <button
                                    type="button"
                                    className={`px-4 py-2 rounded-md font-medium ${activeTab === 'staff' ? 'bg-primary text-white' : 'bg-white/30 text-white-dark'}`}
