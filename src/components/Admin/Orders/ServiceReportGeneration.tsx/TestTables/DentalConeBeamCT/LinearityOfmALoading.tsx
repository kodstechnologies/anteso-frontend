        ...
        <table className="w-max min-w-full divide-y divide-gray-200">
          <thead className="bg-blue-50">
            <tr>
              ...
              <th
                rowSpan={2}
                className="px-6 py-3 w-28 min-w-[7rem] text-left text-xs font-medium text-gray-700 tracking-wider border-r whitespace-nowrap sticky left-0 bg-blue-50 z-10"
              >
                mA
              </th>
              <th
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {processedTable2.rows.map((p, rowIdx) => (
              <tr key={p.id} className="hover:bg-gray-50">
                <td className="px-4 py-2 border-r min-w-[7rem] sticky left-0 bg-white z-10">
                  <input
                    type="text"
                    value={p.ma}
                ...
                <td className="px-4 py-2 text-center border-r font-medium bg-gray-50 whitespace-nowrap min-w-[6rem]">
                  {p.average}
                </td>
                <td className="px-4 py-2 text-center border-r font-medium bg-gray-50 whitespace-nowrap min-w-[6rem]">
                  {p.x}
                ...
                {rowIdx === 0 && (
                  <>
                    <td
                      ...
                      className="px-4 py-2 text-center border-r font-medium bg-yellow-50 align-middle whitespace-nowrap min-w-[5rem]"
                    >
                    ...
                    <td
                      rowSpan={processedTable2.summary.rowSpan}
                      className="px-4 py-2 text-center border-r font-medium bg-yellow-50 align-middle whitespace-nowrap min-w-[4rem]"
                    >
                      {processedTable2.summary.col}
                    </td>
                    <td
                      rowSpan={processedTable2.summary.rowSpan}
                      className="px-4 py-2 text-center align-middle min-w-[5rem]"
                    >
                      <span
