...
import {
  addLinearityOfMasLoadingStationsForRadiographyMobile,
  getLinearityOfMasLoadingStationsByServiceIdForRadiographyMobile,
  updateLinearityOfMasLoadingStationsForRadiographyMobile,
} from '../../../../../../api';
...
const LinearityOfMasLoading: React.FC<Props> = ({ serviceId, testId: propTestId, onRefresh }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (!currentTestId) {
        try {
          const existing = await getLinearityOfMasLoadingStationsByServiceIdForRadiographyMobile(serviceId);
      ...
      if (currentTestId) {
        result = await updateLinearityOfMasLoadingStationsForRadiographyMobile(currentTestId, payload);
        toast.success('Updated successfully!');
      } else {
        result = await addLinearityOfMasLoadingStationsForRadiographyMobile(serviceId, payload);
