...
import {
  addConsistencyOfRadiationOutputForRadiographyMobile,
  getConsistencyOfRadiationOutputByServiceIdForRadiographyMobile,
  updateConsistencyOfRadiationOutputForRadiographyMobile,
} from '../../../../../../api';
...
const ConsistencyOfRadiationOutput: React.FC<Props> = ({
  ...
  useEffect(() => {
    ...
    const loadTest = async () => {
      setIsLoading(true);
      try {
        const data = await getConsistencyOfRadiationOutputByServiceIdForRadiographyMobile(serviceId);
        if (data?.data) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      let result;
      if (testId) {
        result = await updateConsistencyOfRadiationOutputForRadiographyMobile(testId, payload);
      } else {
        result = await addConsistencyOfRadiationOutputForRadiographyMobile(serviceId, payload);
        if (result?.data?._id) {
