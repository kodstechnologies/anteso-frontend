...
import {
  addAccuracyOfIrradiationTimeForRadiographyMobile,
  getAccuracyOfIrradiationTimeByServiceIdForRadiographyMobile,
  updateAccuracyOfIrradiationTimeForRadiographyMobile,
} from "../../../../../../api";
...
const AccuracyOfIrradiationTime: React.FC<AccuracyOfIrradiationTimeProps> = ({
  ...
  const handleSave = async () => {
    ...
    try {
      let res;
      if (testId) {
        res = await updateAccuracyOfIrradiationTimeForRadiographyMobile(testId, payload);
      } else {
        res = await addAccuracyOfIrradiationTimeForRadiographyMobile(serviceId, payload);
      }
