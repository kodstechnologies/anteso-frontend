...
import {
  addCentralBeamAlignmentForRadiographyMobile,
  getCentralBeamAlignmentByServiceIdForRadiographyMobile,
  updateCentralBeamAlignmentForRadiographyMobile,
} from '../../../../../../api';
...
const CentralBeamAlignment: React.FC<Props> = ({ serviceId, testId: propTestId, onTestSaved }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      let res;
      if (testId) {
        res = await updateCentralBeamAlignmentForRadiographyMobile(testId, payload);
        toast.success('Updated successfully!');
      } else {
        res = await addCentralBeamAlignmentForRadiographyMobile(serviceId, payload);
