...
import {
  addCongruenceForRadiographyMobile,
  getCongruenceByServiceIdForRadiographyMobile,
  updateCongruenceForRadiographyMobile,
} from '../../../../../../api';
...
const CongruenceOfRadiation: React.FC<Props> = ({ serviceId, testId: propTestId, onTestSaved }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      let res;
      if (testId) {
        res = await updateCongruenceForRadiographyMobile(testId, payload);
        toast.success('Updated successfully!');
      } else {
        res = await addCongruenceForRadiographyMobile(serviceId, payload);
