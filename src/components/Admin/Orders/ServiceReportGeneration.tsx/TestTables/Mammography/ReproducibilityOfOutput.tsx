    ...
    <div className="p-6 max-w-full overflow-x-auto space-y-8">
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-blue-50">
              ...
              <tr>
                ...
                {/* Dynamic measured columns + Add button */}
                <th
                  ...
                  >
                    <div className="flex items-center justify-center gap-1">
                      <input
                        ...
                        className="w-24 px-1 py-0.5 text-xs border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <tr key={row.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-2 border-r">
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded text-sm text-center bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-500"
                      placeholder="1.25"
                    />
                  </td>
      ...
      <div className="bg-white shadow-md rounded-lg p-6 max-w-md">
        <label className="block text-sm font-medium text-gray-700 mb-2">
          Acceptance Criteria (Coefficient of Variation)
        </label>
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            className="w-32 px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-center focus:outline-none focus:ring-2 focus:ring-blue-500"
            placeholder="5.0"
          />
          <span className="text-sm text-gray-600">%</span>
        </div>
        <p className="text-xs text-gray-500 mt-2">
          Typical limit for reproducibility: ≤ 5% (IEC 61223-3-1 / AERB)
        </p>
      </div>
    </div>
  );
