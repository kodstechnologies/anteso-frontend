...
import {
    addRadiationProtectionSurveyForOBI,
    getRadiationProtectionSurveyByServiceIdForOBI,
    updateRadiationProtectionSurveyForOBI,
} from "../../../../../../api";
...
const RadiationProtectionSurvey: React.FC<Props> = ({ serviceId }) => {
    ...
    useEffect(() => {
        const load = async () => {
            ...
            try {
                const res = await getRadiationProtectionSurveyByServiceIdForOBI(serviceId);
                const data = res?.data;
                if (data) {
    ...
    const handleSave = async () => {
        ...
        try {
            let res;
            if (testId) {
                res = await updateRadiationProtectionSurveyForOBI(testId, payload);
                toast.success("Updated successfully");
            } else {
                res = await addRadiationProtectionSurveyForOBI(serviceId, payload);
