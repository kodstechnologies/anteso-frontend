...
import {
    addCentralBeamAlignmentForOBI,
    getCentralBeamAlignmentByServiceIdForOBI,
    updateCentralBeamAlignmentForOBI,
} from '../../../../../../api';
...
const CentralBeamAlignment: React.FC<Props> = ({ serviceId, testId: propTestId, onTestSaved, refreshKey, initialData }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            let res;
            if (testId) {
                res = await updateCentralBeamAlignmentForOBI(testId, payload);
                toast.success('Updated successfully!');
            } else {
                res = await addCentralBeamAlignmentForOBI(serviceId, payload);
