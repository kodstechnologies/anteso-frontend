...
import {
  addLowContrastSensitivityForOBI,
  getLowContrastSensitivityByTestIdForOBI,
  getLowContrastSensitivityByServiceIdForOBI,
  updateLowContrastSensitivityForOBI,
} from "../../../../../../api";
...
const LowContrastSensitivity: React.FC<Props> = ({
  ...
  const handleSave = async () => {
    ...
    try {
      if (testId) {
        await updateLowContrastSensitivityForOBI(testId, payload);
