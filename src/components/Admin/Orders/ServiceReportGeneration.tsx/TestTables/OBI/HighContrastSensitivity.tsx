...
import {
  addHighContrastSensitivityForOBI,
  getHighContrastSensitivityByTestIdForOBI,
  getHighContrastSensitivityByServiceIdForOBI,
  updateHighContrastSensitivityForOBI,
} from "../../../../../../api";
...
const HighContrastSensitivity: React.FC<Props> = ({
  ...
  const handleSave = async () => {
    ...
    try {
      if (testId) {
        await updateHighContrastSensitivityForOBI(testId, payload);
        toast.success("Updated successfully!");
      } else {
        const res = await addHighContrastSensitivityForOBI(serviceId, payload);
