...
interface MeasurementRow {
  ...
  radiationOutput1: string; // Radiation Output (mGy) - measurement 1
  radiationOutput2: string; // Radiation Output (mGy) - measurement 2
  radiationOutput3: string; // Radiation Output (mGy) - measurement 3
