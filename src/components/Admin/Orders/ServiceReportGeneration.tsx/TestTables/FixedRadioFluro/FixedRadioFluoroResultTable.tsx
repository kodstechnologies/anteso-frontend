...
interface FixedRadioFlouroResultTableProps {
    testResults: TestResult[];
    onUpdate?: (index: number, field: keyof TestResult, value: string) => void;
}

const FixedRadioFlouroResultTable: React.FC<FixedRadioFlouroResultTableProps> = ({
    testResults,
    onUpdate,
}) => {
    return (
...
export default FixedRadioFlouroResultTable;