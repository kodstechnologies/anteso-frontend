...
interface TiltRow {
  id: string;
  value: string; // degrees — only the measured value
  remark: 'Pass' | 'Fail' | '';
}
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-12">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Evaluate central beam perpendicularity using steel ball radiograph</p>
        </div>
        <button
          onClick={isViewOnly ? startEditing : handleSave}
          disabled={isSaving}
          className={`flex items-center gap-3 px-8 py-4 rounded-xl font-semibold text-white transition-all shadow-lg ${
            isSaving
      ...
      <div className="bg-white shadow-xl rounded-2xl border border-gray-200 overflow-hidden">
        ...
        <div className="p-12">
          <div className="flex flex-col items-center gap-10">
            ...
            <div className="mt-8">
              <span className={`px-16 py-8 rounded-full text-3xl font-bold shadow-lg border-4 ${
                evaluation.remark === 'Pass'
      ...
      <div className="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 border-4 border-indigo-500 rounded-3xl p-12 text-center shadow-2xl">
        ...
        <div className="mt-12">
          <p className="text-2xl font-bold text-indigo-900">
            Final Result: <span className={`ml-4 px-8 py-4 rounded-full text-3xl ${
              finalResult === 'PASS' ? 'bg-green-500 text-white' :
