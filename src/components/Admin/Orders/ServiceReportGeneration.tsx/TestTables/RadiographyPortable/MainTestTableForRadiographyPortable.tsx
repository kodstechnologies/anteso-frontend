  ...
  return (
    <div className="mt-4 print:mt-2">
      ...
      <div className="overflow-x-auto print:overflow-visible print:max-w-none flex justify-center">
        <table className="border border-black text-xs print:text-[9px] print:min-w-full" style={{ width: '100%', textAlign: 'center', borderCollapse: 'collapse', borderWidth: 1, borderStyle: 'solid', borderColor: '#000' }}>
