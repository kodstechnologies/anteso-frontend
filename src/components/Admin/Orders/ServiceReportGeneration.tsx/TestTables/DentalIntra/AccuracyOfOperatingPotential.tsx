...
import {
    addAccuracyOfOperatingPotentialForDentalIntra,
            ...
            try {
                ...
                if (data) {
                    ...
                    if (!hasCsvImport) {
                        ...
                        // Preserve CSV-imported dynamic headers/rows instead of overwriting from server.
                        setIsSaved(false);
                        setIsEditing(true);
                    }
    ...
    const saveTest = async () => {
        ...
        try {
            ...
            if (testId) {
                ...
                result = await addAccuracyOfOperatingPotentialForDentalIntra(serviceId, payload);
