...
import {
  addLinearityOfMasLoadingForCTScan,
  getLinearityOfMasLoadingByServiceIdForCTScan,
  getLinearityOfMasLoadingByTestIdForCTScan,
  updateLinearityOfMasLoadingForCTScan,
} from '../../../../../../api';
...
const LinearityOfMasLoading: React.FC<Props> = ({ serviceId, testId: propTestId = null, onTestSaved, onRefresh }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (currentTestId) {
        result = await updateLinearityOfMasLoadingForCTScan(currentTestId, payload);
        toast.success('Updated successfully!');
      } else {
        result = await addLinearityOfMasLoadingForCTScan(serviceId, payload);
