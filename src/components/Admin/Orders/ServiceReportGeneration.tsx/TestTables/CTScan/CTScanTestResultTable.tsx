// components/TestTables/CTScanTestResultTable.tsx
...
interface CTScanTestResultTableProps {
    testResults: TestResult[];
    onUpdate?: (index: number, field: keyof TestResult, value: string) => void;
}

const CTScanTestResultTable: React.FC<CTScanTestResultTableProps> = ({
    testResults,
    onUpdate,
}) => {
    return (
...
export default CTScanTestResultTable;