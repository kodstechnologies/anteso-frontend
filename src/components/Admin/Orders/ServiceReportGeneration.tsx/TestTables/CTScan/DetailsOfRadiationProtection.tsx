...
import {
  addRadiationProtectionSurveyForCTScan,
  getRadiationProtectionSurveyByServiceIdForCTScan,
  getRadiationProtectionSurveyByTestIdForCTScan,
  updateRadiationProtectionSurveyForCTScan,
  getTools,
} from "../../../../../../api";
...
const RadiationProtectionSurvey: React.FC<Props> = ({ serviceId, tubeId }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      let res;
      if (testId) {
        res = await updateRadiationProtectionSurveyForCTScan(testId, payload);
        toast.success("Updated successfully");
      } else {
        res = await addRadiationProtectionSurveyForCTScan(serviceId, payload);
