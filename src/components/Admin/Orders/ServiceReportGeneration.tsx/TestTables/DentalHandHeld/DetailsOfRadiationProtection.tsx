...
import {
  addRadiationProtectionSurveyForDentalHandHeld,
  getRadiationProtectionSurveyByServiceIdForDentalHandHeld,
  getRadiationProtectionSurveyByTestIdForDentalHandHeld,
  updateRadiationProtectionSurveyForDentalHandHeld,
  getTools,
} from "../../../../../../api";
...
const DetailsOfRadiationProtection: React.FC<Props> = ({ serviceId, testId: propTestId = null, onTestSaved, csvData }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      let res;
      if (testId) {
        res = await updateRadiationProtectionSurveyForDentalHandHeld(testId, payload);
        toast.success("Updated successfully");
      } else {
        res = await addRadiationProtectionSurveyForDentalHandHeld(serviceId, payload);
