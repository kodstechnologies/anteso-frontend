// src/components/TestTables/HighContrastResolution.tsx
        ...
        const loadTest = async () => {
            ...
            try {
                ...
                if (data?.data) {
                    ...
                    setMeasuredLpPerMm(data.data.measuredLpPerMm || '');
                    setRecommendedStandard(data.data.recommendedStandard || '1.50');
                    setIsSaved(true);
                    setIsEditing(false);
                } else {
                    setIsSaved(false);
