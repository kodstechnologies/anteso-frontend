...
interface EquipmentSettingForInterventionalRadiologyProps {
...
const EquipmentSettingForInterventionalRadiology: React.FC<EquipmentSettingForInterventionalRadiologyProps> = ({
  appliedCurrent = "",
  appliedVoltage = "",
  exposureTime = "",
  focalSpotSize = "",
...
export default EquipmentSettingForInterventionalRadiology;