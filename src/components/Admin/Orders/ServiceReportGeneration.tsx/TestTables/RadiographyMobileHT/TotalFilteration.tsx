// src/components/TestTables/TotalFilterationForRadiographyMobileHT.tsx
        ...
        <div className="p-6 max-w-full overflow-x-auto space-y-10">
            ...
            <div className="flex justify-end">
                <button
                    ...
                    disabled={isSaving}
                    className={`flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition ${isSaved && !isEditing
