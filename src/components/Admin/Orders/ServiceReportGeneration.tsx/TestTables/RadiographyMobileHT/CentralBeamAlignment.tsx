...
import {
  addCentralBeamAlignmentForRadiographyMobileHT,
  getCentralBeamAlignmentByServiceIdForRadiographyMobileHT,
  updateCentralBeamAlignmentForRadiographyMobileHT,
} from '../../../../../../api';
...
const CentralBeamAlignment: React.FC<Props> = ({ serviceId, testId: propTestId, onTestSaved }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      let res;
      if (testId) {
        res = await updateCentralBeamAlignmentForRadiographyMobileHT(testId, payload);
        toast.success('Updated successfully!');
      } else {
        res = await addCentralBeamAlignmentForRadiographyMobileHT(serviceId, payload);
