...
import {
  addAccuracyOfIrradiationTimeForRadiographyMobileHT,
  getAccuracyOfIrradiationTimeByServiceIdForRadiographyMobileHT,
  updateAccuracyOfIrradiationTimeForRadiographyMobileHT,
} from "../../../../../../api";
...
const AccuracyOfIrradiationTime: React.FC<AccuracyOfIrradiationTimeProps> = ({
  ...
  const handleSave = async () => {
    ...
    try {
      let res;
      if (testId) {
        res = await updateAccuracyOfIrradiationTimeForRadiographyMobileHT(testId, payload);
      } else {
        res = await addAccuracyOfIrradiationTimeForRadiographyMobileHT(serviceId, payload);
      }
