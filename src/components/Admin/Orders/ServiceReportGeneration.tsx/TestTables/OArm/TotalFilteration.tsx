// src/components/TestTables/TotalFilterationForOArm.tsx
...
const TotalFilteration: React.FC<TotalFilterationProps> = ({
    ...
    useEffect(() => {
        const loadTestData = async () => {
            ...
            try {
                ...
                if (initialTestId) {
                    data = await getTotalFilterationForOArm(initialTestId);
                } else {
    ...
    const saveTest = async () => {
        ...
        try {
            let result;
            if (testId) {
                result = await updateTotalFilterationForOArm(testId, payload);
                toast.success("Updated successfully");
            } else {
                result = await createTotalFilterationForOArm(serviceId, payload);
