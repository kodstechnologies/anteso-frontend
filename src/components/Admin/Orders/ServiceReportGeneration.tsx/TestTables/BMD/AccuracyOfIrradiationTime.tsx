...
import {
  // TODO: Add these API functions when BMD backend supports AccuracyOfIrradiationTime
...
const AccuracyOfIrradiationTime: React.FC<AccuracyOfIrradiationTimeProps> = ({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Temporary: Show message that API is not yet implemented
      toast.error("API functions for BMD AccuracyOfIrradiationTime are not yet implemented");
    } catch (err: any) {
